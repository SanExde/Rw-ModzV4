...
'menbalas', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database","quran', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'nocategory']
...
rows: [
{title: `${emot} GROUP BOT`, rowId: ".gcsann", description: "Group San Xd Official"},
